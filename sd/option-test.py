...
parser = argparse.ArgumentParser(description='SD')
...
parser.add_argument('--rgb-list', default='list/c3d-mirror.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='list/testing-list.list', help='list of test rgb features ')
...
parser.add_argument('--pretrained-ckpt', default='./ckpt/model-plain.pkl', help='ckpt for pretrained model')
parser.add_argument('--num-classes', type=int, default=1, help='number of class')
parser.add_argument('--dataset-name', default='CAD', help='dataset to train on (default: )')
