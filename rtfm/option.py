...
parser.add_argument('--rgb-list', default='list/c3d-train.list', help='list of rgb features ')
...
parser.add_argument('--pretrained-ckpt', default='ckpt/rtfm-7-11.pkl', help='ckpt for pretrained model')
