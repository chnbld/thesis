...
parser.add_argument('--rgb-list', default='/proposal/rtfm-load/list/c3d-train.list', help='list of rgb features ')
parser.add_argument('--test-rgb-list', default='/proposal/rtfm-load/list/testing-list.list', help='list of test rgb features ')
parser.add_argument('--gt', default='/proposal/rtfm-load/list/gt.npy', help='file of ground truth ')
...
parser.add_argument('--model-name', default='rtfm-7-11', help='name to save model')
